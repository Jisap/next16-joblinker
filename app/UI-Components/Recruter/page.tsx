    ...
    <>
      ...
      <div className="px-[8%] lg:px-[12%] py-10">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-7 gap-5"
        >
          {RecruterData.map((item, index) => (
            ...
            >
              <Link href={`/UI-Components/Recruter/${item.id}`} className="flex flex-col shadow-xl shadow-white/15 p-5 rounded-md group hover:bg-prim cursor-pointer transition-all duration-300">
